...
def main(_):
  ...
  test_image_file = 'f:/work/python/ml/tesor/test/5/img_389.jpg'
  test_one_image(test_image_file)
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      default=  'f:/tmp/mnist/logs/fully_connected_feed',
